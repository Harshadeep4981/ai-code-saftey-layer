...
EMAIL = os.getenv("EMAIL_ID")  # your verified Gmail address
...
def send_otp_email(receiver_email: str, otp: str):
    ...
    payload = {
        "sender": {"name": "AI Safety Layer", "email": EMAIL},
        "to": [{"email": receiver_email}],
        "subject": "AI Safety Layer - Email Verification",
        "htmlContent": html,
    }
    ...
    if response.status_code >= 400:
        # log the actual reason instead of letting it silently 500
